<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pricepicking1.aspx.vb" Inherits="Web01.pricepicking1" maintainscrollpositiononpostback="true"  %>
...
<asp:ListItem Value="dbo.View_basicinfo.[漲幅]">漲幅%</asp:ListItem>
<asp:ListItem Value="dbo.View_basicinfo.總量">總量</asp:ListItem>
<asp:ListItem Value="[週轉率%]">週轉率%</asp:ListItem>
<asp:ListItem Value="linedaysort.站均">站上均價數</asp:ListItem>

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="goldencrosspicking.aspx.vb" Inherits="Web01.goldencrosspicking" maintainscrollpositiononpostback="true" %>
    ...
    <form id="form1" runat="server">
     ...
     <asp:Label ID="Label28" runat="server" Font-Names="標楷體" ForeColor="#0000CC" Text="起日:"></asp:Label>
        ...
        <span class="btn btn-default">
            ...
            </span></span></span>&nbsp;<asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource2" ForeColor="Black" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellSpacing="2" ToolTip="總量預設大於500張">
                <Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:stockchangedateConnectionString %>" SelectCommand="SELECT TOP (100) PERCENT trend.名稱, trend.代號, avggold三大法人.漲幅,avggold三大法人.成交價, avggold三大法人.總量, avggold.均價黃金交叉次數, avggold.均量黃金交叉次數, avggold三大法人.三大法人黃金交叉次數, avggold三大法人.外資黃金交叉次數, avggold三大法人.投信黃金交叉次數, day1macd.macd, day1kd.日黃金交叉 as kd日黃金交叉, day1kd.週黃金交叉 as kd週黃金交叉, day1kd.月黃金交叉 as kd月黃金交叉, 主力加法人佔股本比彙總.[三大法人佔股本比%一天], 主力加法人佔股本比彙總.[主力佔股本比%一天], 主力加法人佔股本比彙總.合計一天, 主力加法人佔股本比彙總.法人三天, 主力加法人佔股本比彙總.主力三天, 主力加法人佔股本比彙總.合計三天, 主力加法人佔股本比彙總.法人五天, 主力加法人佔股本比彙總.主力五天, 主力加法人佔股本比彙總.合計五天, 主力加法人佔股本比彙總.法人十天, 主力加法人佔股本比彙總.主力十天, 主力加法人佔股本比彙總.合計十天, 主力加法人佔股本比彙總.法人二十天, 主力加法人佔股本比彙總.主力二十天, 主力加法人佔股本比彙總.合計二十天, 主力加法人佔股本比彙總.法人預設, 主力加法人佔股本比彙總.主力預設, 主力加法人佔股本比彙總.合計預設, avggold.交易所分類, avggold.股本億, avggold.日期 FROM avggold INNER JOIN trend ON avggold.股票代號 = trend.代號 INNER JOIN avggold三大法人 ON trend.代號 = avggold三大法人.股票代號 INNER JOIN day1kd ON trend.代號 = day1kd.股票代號 INNER JOIN day1macd ON trend.代號 = day1macd.股票代號 INNER JOIN 主力加法人佔股本比彙總 ON trend.代號 = 主力加法人佔股本比彙總.代號 where avggold三大法人.總量&gt;500 ORDER BY avggold.均價黃金交叉次數 DESC, avggold三大法人.三大法人黃金交叉次數 DESC, 主力加法人佔股本比彙總.合計一天 DESC"></asp:SqlDataSource>

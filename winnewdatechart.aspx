<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="winnewdatechart.aspx.vb" Inherits="Web01.winnewdatechart" maintainscrollpositiononpostback="true"  %>
    ...
    <form id="form1" runat="server">
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark ptest2">
        ...
        <div>
            ...
            (<asp:Label ID="Label1" runat="server" Text="股名:"></asp:Label>
            ...
            <asp:Button ID="Button3" runat="server" Text="設定股票及區間" Width="127px" BackColor="Black" ForeColor="White" ToolTip="設定查詢股票及區間,自動調整成最新的月份及季度,只須輸入左方的股票名稱" />
            ) 
             (<asp:CheckBox ID="不顯示" runat="server" ToolTip="是否顯示圖表的數字及gridview2及gridviewone互相切換分頁選擇(只能調整筆數不能支援分頁的顯示,不能選第二頁等單頁顯示全部才能使用選取功能)" />
       
     
      
             <asp:Button ID="計算56" runat="server" Height="31px" Text="1.價量黃金交叉(含圖)" Width="168px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="資料表方式顯示股權資料" />
       
     
      
            <asp:Button ID="計算57" runat="server" Height="31px" Text="2.法人黃金交叉" Width="130px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="輸入股票名稱" />
       
     
      
             <asp:Button ID="計算58" runat="server" Height="31px" Text="3.融資融券比率" Width="130px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="輸入股票名稱" />
       
     
      
             <asp:Button ID="計算59" runat="server" Height="31px" Text="4.融資融券黃金交叉" Width="160px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="輸入股票名稱" />
       
     
      
             <asp:Button ID="計算60" runat="server" Height="31px" Text="放大" Width="51px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="放大圖表,均價及均量" />
        ...
        <span class="btn btn-default">
            ...
            <asp:Button ID="Button153" runat="server" Text="價增加" Width="68px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量? + 近四期均價加總(近1天均價-近2年均價)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            <asp:Button ID="Button154" runat="server" Text="量增加" Width="68px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量? + 近四期均量加總(近1天均量-近2年均量)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
            ...
            </span></span></span>&nbsp;<asp:Label ID="Label4" runat="server" Text="選股:(總量 &gt;"></asp:Label>
                          <span class="style1"><span class="auto-style2 btn-default"><span class="auto-style4">
                          <asp:TextBox ID="總量" 
            ...
            </span></span></span><asp:Label ID="Label29" runat="server" Text="Macd &gt;"></asp:Label>
                          <span class="style1"><span class="auto-style2 btn-default"><span class="auto-style4">
            ...
            runat="server" class="text-muted" Height="20px" Width="40px" Font-Size="Medium" ToolTip="" CssClass="auto-style5 text-center" BackColor="#99FF66" ForeColor="Maroon">1</asp:TextBox>
...
<br/>      
            ...
            (<asp:Button ID="Button155" runat="server" Text="價增加4" Width="81px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量? + 近四期均價加總(近1天均價-近2年均價)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            <asp:Button ID="Button160" runat="server" Text="5" Width="32px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量>=?,近5期均價加總(近1天均價-近2年均價)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            <asp:Button ID="Button161" runat="server" Text="6" Width="32px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量>=?,近6期均價加總(近1天均價-近2年均價)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            <asp:Button ID="Button162" runat="server" Text="7" Width="32px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量>=?,近7期均價加總(近1天均價-近2年均價)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            <asp:Button ID="Button163" runat="server" Text="8" Width="32px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量>=?,近8期均價加總(近1天均價-近2年均價)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            )(<asp:Button ID="Button156" runat="server" Text="量增加4" Width="79px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量? + 近四期均量加總(近1天均量-近2年均量)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            <asp:Button ID="Button164" runat="server" Text="5" Width="35px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量? + 近5期均量加總(近1天均量-近2年均量)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            <asp:Button ID="Button165" runat="server" Text="6" Width="35px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量? + 近6期均量加總(近1天均量-近2年均量)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            <asp:Button ID="Button166" runat="server" Text="7" Width="35px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量? + 近7期均量加總(近1天均量-近2年均量)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            <asp:Button ID="Button167" runat="server" Text="8" Width="35px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量? + 近8期均量加總(近1天均量-近2年均量)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            )<asp:Button ID="Button157" runat="server" Text="三大法人增加" Width="110px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量?,近四期均價加總(近1天均價-近2年均價)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            <asp:Button ID="Button158" runat="server" Text="外資增加" Width="81px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量?,近四期均價加總(近1天均價-近2年均價)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            <asp:Button ID="Button159" runat="server" Text="投信增加" Width="86px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量?,近四期均價加總(近1天均價-近2年均價)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
            ...
            (<asp:Button ID="Button168" runat="server" Text="彙總+macdj" Width="104px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="加入macd+kdj的J值修件,列出macd紅綠棒值>-0.2 j值>0 且連三天過高,價量黃金交叉數>0"/>
                                                                                     ...
                                                                                     <asp:Button ID="Button169" runat="server" Text="彙總+macdj全部" Width="134px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="加入macd+kdj的J值修件,列出全部資料>0"/>
                                                                                     ...
                                                                                     )<asp:Button ID="計算61" runat="server" Height="28px" Text="OBV增加" Width="86px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="資料表方式顯示股權資料" />
...
<asp:ListItem Value="dbo.View_basicinfo.[漲幅]">漲幅%</asp:ListItem>
<asp:ListItem Value="dbo.View_basicinfo.總量">總量</asp:ListItem>
...
<asp:ListItem Value="dbo.主力加法人佔股本比彙總.合計預設">合計預設</asp:ListItem>
            ...
            <asp:ListItem Value="incomechar29">自選股29</asp:ListItem>
                          ...
                          )<br />        </span></span></span><asp:GridView ID="GridViewone" runat="server" AutoGenerateSelectButton="True" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" ForeColor="Black" CellSpacing="2" AllowPaging="True">
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:stockchangedateConnectionString %>" SelectCommand="SELECT [股票名稱], [股票代號], [站均], [均價黃金交叉次數], [均量黃金交叉次數], [三大法人黃金交叉次數], [外資黃金交叉次數], [投信黃金交叉次數], [資使用率], [資使用率黃金交叉次數], [券使用率], [券使用率黃金交叉次數], [券資比], [券資比黃金交叉次數], [日期] FROM [View_winnew] ORDER BY [站均] DESC, [均價黃金交叉次數] DESC, [均量黃金交叉次數] DESC">
            </asp:SqlDataSource>
                    ...
                    <asp:Chart ID="chart1" runat="server" Height="538px" ImageType="Bmp" SuppressExceptions="True" ValidateRequestMode="Enabled" Width="1349px">
                        <series>
                            <asp:Series BackGradientStyle="Center" BackHatchStyle="Percent70" BackSecondaryColor="255, 255, 192" BorderColor="Blue" ChartArea="ChartArea1" Color="White" Font="標楷體, 8.25pt, style=Italic" LabelBackColor="White" LabelToolTip="站上股價平均線數量" LegendText="1.站上股價平均線數量(+8~-8) 2.三大法人黃金交叉 3.融資比率 4.融資黃金交叉" LegendToolTip="站上股價平均線數量" MarkerBorderColor="Red" MarkerBorderWidth="3" MarkerColor="Red" MarkerStyle="Star10" Name="Series1" Palette="Bright" XValueType="Double" YValueType="Int64" ChartType="Spline" Legend="Legend1" MarkerSize="10" MarkerStep="5" YValuesPerPoint="10" LabelForeColor="Red">
                            </asp:Series>
                           
                              <asp:Series BackGradientStyle="Center" BackHatchStyle="Percent70" BackSecondaryColor="255, 255, 192" BorderColor="Blue" ChartArea="ChartArea1" Color="White" Font="標楷體, 8.25pt, style=Italic" LabelBackColor="White" LabelToolTip="均價黃金交叉次數" LegendText="1.均價黃金交叉次數(+8~-8) 2.外資黃金交叉 3.融券比率 4.融券黃金交叉" LegendToolTip="均價黃金交叉次數" MarkerBorderColor="Green" MarkerBorderWidth="3" MarkerColor="Green" MarkerStyle="Star4" Name="Series2" Palette="Chocolate" XValueType="Double" YValueType="Int64" ChartType="Spline" Legend="Legend1" MarkerSize="10" MarkerStep="5" YValuesPerPoint="10" LabelForeColor="Green">
                            </asp:Series>
                              <asp:Series BackGradientStyle="Center" BackHatchStyle="Percent70" BackSecondaryColor="255, 255, 192" BorderColor="Blue" ChartArea="ChartArea1" Color="White" Font="標楷體, 8.25pt, style=Italic" LabelBackColor="White" LegendText="1.均量黃金交叉次數(+8~-8) 2.投信黃金交叉 3.券資比率 4.券資比黃金交叉" LegendToolTip="均量黃金交叉次數" MarkerBorderColor="Blue" MarkerBorderWidth="3" MarkerColor="Blue" MarkerStyle="Circle" Name="Series3" Palette="Berry" XValueType="Double" YValueType="Int64" ChartType="Spline" Legend="Legend1" MarkerSize="10" MarkerStep="5" YValuesPerPoint="10" LabelForeColor="Blue">
                            </asp:Series>
                        </series>
                        <chartareas>
                            <asp:ChartArea Name="ChartArea1" BackColor="White">
                                <AxisY Title="黃金交叉次數" TitleFont="Microsoft Sans Serif, 14pt" TitleForeColor="Maroon">
                                </AxisY>
                        ...
                        <Legends>
                            <asp:Legend Name="Legend1" Title="圖例說明" ForeColor="SaddleBrown" TitleForeColor="#990000">
                            </asp:Legend>
                        </Legends>
                        <Titles>
                            <asp:Title BackColor="White" Font="標楷體, 20pt" ForeColor="Blue" Name="Title1" Text="均價均量黃金交叉(趨勢)">
                            </asp:Title>
            ...
            <asp:SqlDataSource ID="SqlDataSourcefinance" runat="server" ConnectionString="<%$ ConnectionStrings:stockchangedateConnectionString %>" SelectCommand="SELECT DISTINCT  top 1  自動編號,日期  FROM [financesum] where (代號 = 2330) and (買進 &gt;0) order by 自動編號 desc"></asp:SqlDataSource>
             ...
             <asp:GridView ID="GridViewstart" runat="server" Visible="False">
            </asp:GridView>

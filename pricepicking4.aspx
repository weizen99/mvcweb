<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pricepicking4.aspx.vb" Inherits="Web01.pricepicking4" maintainscrollpositiononpostback="true"  %>
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                           ...
                           <a class="dropdown-item" href="http://220.134.245.185:8888/fishnew5/poemaccesshistory">Asp版主頁</a>
                            ...
                            <a class="dropdown-item" href="http://220.134.245.185:8888/excelimport/excelimport2">SQL指令查詢直接下載成excel</a>
                            <a class="dropdown-item" href="http://220.134.245.185:8888/stockquery/readtext">edge瀏覽器朗讀小說</a>
                            <a class="dropdown-item" href="http://220.134.245.185:8888/work/myherowars.aspx">我的遊戲輔助網頁</a>
...
<asp:TextBox runat="server" ID="movetextbox" style='position: absolute; left: 10px; ' Height="3px" Width="20px" />
        ...
        <div>
            ...
            <asp:Button ID="Button3" runat="server" Text="設定要查詢股票及區間" Width="177px" BackColor="Black" ForeColor="White" ToolTip="設定查詢股票及區間,自動調整成最新的月份及季度,只須輸入左方的股票名稱" />
             ...
             (<asp:CheckBox ID="不顯示" runat="server" ToolTip="是否顯示圖表的數字及gridview2及gridviewone互相切換分頁選擇(只能調整筆數不能支援分頁的顯示,不能選第二頁等單頁顯示全部才能使用選取功能)" />
                ...
                <asp:Button ID="計算56" runat="server" Height="31px" Text="均價標準差查詢(含圖)" Width="175px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="資料表方式顯示股權資料" />
       
     
      
                <asp:Button ID="計算57" runat="server" Height="31px" Text="均量查詢(含圖)" Width="141px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="資料表方式顯示股權資料" />
       
     
      
                <asp:Button ID="計算58" runat="server" Height="31px" Text="OBV量能潮(含圖)" Width="141px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="資料表方式顯示股權資料" />
       
     
      
                <asp:Button ID="計算60" runat="server" Height="31px" Text="OBV多空比淨額法" Width="141px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="資料表方式顯示股權資料" />
       
     
      
                <asp:Button ID="計算61" runat="server" Height="31px" Text="Macd+j(kdj)" Width="107px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="資料表方式顯示股權資料" />
        ...
        &nbsp;&nbsp; <asp:HyperLink ID="income" runat="server" Font-Names="標楷體" Font-Size="Medium" ForeColor="Red" Target="_blank">每月營收</asp:HyperLink>
         ...
         &nbsp;<asp:Button ID="Button137" runat="server" BackColor="#003300" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" Height="34px" Text="綜合圖形" onclientclick="return confirm('提醒!!!:將離開本頁面,跳轉的頁面會自動帶入股票名稱及代號,可直接按綜合累計或至下方加選下拉選單之資料,如:eps 三率等等')" Width="75px" ToolTip="會自動帶入股票名稱及代號,查詢融資融券或eps等資料(回來時原程式未關閉還在執行),或捲動往下方一點的位置==&gt;加選下拉選單之資料" PostBackUrl="http://220.134.245.185:8888/mymvc/trend1.aspx" />
             <br/><br/>
        ...
        <asp:TextBox ID="topno1" 
            ...
            runat="server" class="text-muted" Height="20px" Width="71px" Font-Size="Medium" ToolTip="如果要當成Macd+j值+日期來算日期,例如要五天 1750*4(少1天)+1000=8000" CssClass="auto-style5 text-center" BackColor="#99FF66" ForeColor="Maroon">49</asp:TextBox>
        ...
        <span class="btn btn-default">
            ...
            <asp:Button ID="Button160" runat="server" Text="均價自動看圖" Width="125px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="搜尋出來的內容,自動播放均價標準差圖形" Visible="False"/>
            ...
            <asp:Button ID="Button161" runat="server" Text="均量自動看圖" Width="125px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="搜尋出來的內容,自動播放均量標準差圖形" Visible="False"/>
          
                                                                                     

                <asp:Button ID="計算59" runat="server" Height="28px" Text="OBV增加" Width="86px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="資料表方式顯示股權資料" />
       
     
      
                (<asp:Button ID="計算66" runat="server" Height="31px" Text="改參數" Width="61px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="同左,但要自訂日期請在取前?名的方塊內輸入一個數字,例如要五天 1750*4(少1天)+1000=8000" />
       
     
      
                <asp:Button ID="計算62" runat="server" Height="31px" Text="Macd+j值" Width="92px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="macd跟j值的參數:使用上面的文字方塊來作輸入(macd >= Macd文字方塊 and macd <= 日kd文字方塊)  (當日J值 >= 週kd文字方塊 and 當日J值 <= 月kd文字方塊,列出近三天符合的資料" />
       
     
      
                <asp:Button ID="計算64" runat="server" Height="31px" Text="左+j連三增" Width="92px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="macd跟j值的參數:使用上面的文字方塊來作輸入(macd >= Macd文字方塊 and macd <= 日kd文字方塊)  (當日J值 >= 週kd文字方塊 and 當日J值 <= 月kd文字方塊,列出近三天符合的資料" />
       
     
      
                <asp:Button ID="計算65" runat="server" Height="31px" Text="左+j過三高" Width="92px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="macd跟j值的參數:使用上面的文字方塊來作輸入(macd >= Macd文字方塊 and macd <= 日kd文字方塊)  (當日J值 >= 週kd文字方塊 and 當日J值 <= 月kd文字方塊,列出近三天符合的資料" />
       
     
      
                <asp:Button ID="計算63" runat="server" Height="31px" Text="Macd+j值+日期" Width="120px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="同左,但要自訂日期請在取前?名的方塊內輸入一個數字,例如要五天 1750*4(少1天)+1000=8000" />
...
<asp:ListItem Value="集中度240日">集中度240日</asp:ListItem>
...
<asp:ListItem Value="集中度240日">集中度240日</asp:ListItem>
            ...
            <asp:Label ID="Label40" runat="server" Text="第一層:總量&gt;?+"></asp:Label>
                          (<asp:TextBox ID="macdlendown" 

            runat="server" class="text-muted" Height="20px" Width="50px" Font-Size="Medium" ToolTip="參數(比率或次數等等)" CssClass="auto-style5 text-center" BackColor="#99FF66" ForeColor="Maroon">-0.05</asp:TextBox>

            <asp:Label ID="Label41" runat="server" Text="&lt;=紅綠棒值&lt;="></asp:Label>
                          <asp:TextBox ID="macdlenup" 

            runat="server" class="text-muted" Height="20px" Width="50px" Font-Size="Medium" ToolTip="參數(比率或次數等等)" CssClass="auto-style5 text-center" BackColor="#99FF66" ForeColor="Maroon">50</asp:TextBox>

                                                                                     
            <asp:Button ID="Button162" runat="server" Text="macd紅綠棒" Width="99px" BackColor="#6600CC" ForeColor="White" Font-Names="標楷體" ToolTip="符合MACD KD+均價 均量 法人籌碼" />
          
                )
            <asp:Label ID="Label42" runat="server" Text="第二層:+"></asp:Label>
                          (<asp:TextBox ID="jdown" 

            runat="server" class="text-muted" Height="20px" Width="50px" Font-Size="Medium" ToolTip="參數(比率或次數等等)" CssClass="auto-style5 text-center" BackColor="#99FF66" ForeColor="Maroon">0</asp:TextBox>

            <asp:Label ID="Label43" runat="server" Text="&lt;=今日J值&lt;="></asp:Label>
                          <asp:TextBox ID="jup" 

            runat="server" class="text-muted" Height="20px" Width="50px" Font-Size="Medium" ToolTip="參數(比率或次數等等)" CssClass="auto-style5 text-center" BackColor="#99FF66" ForeColor="Maroon">50</asp:TextBox>

                                                                                     
            <asp:Button ID="Button163" runat="server" Text="J值" Width="66px" BackColor="#6600CC" ForeColor="White" Font-Names="標楷體" ToolTip="符合MACD KD+均價 均量 法人籌碼" />
                    ...
                    <asp:Chart ID="chart1" runat="server" Height="538px" ImageType="Bmp" SuppressExceptions="True" ValidateRequestMode="Enabled" Width="1349px" DataSourceID="SqlDataSource1">
                        <series>
                            <asp:Series BackGradientStyle="Center" BackHatchStyle="Percent70" BackSecondaryColor="255, 255, 192" BorderColor="Blue" ChartArea="ChartArea1" Color="White" Font="Microsoft Sans Serif, 8pt, style=Italic" LabelBackColor="White" LabelToolTip="成交價" LegendText="成交價" LegendToolTip="成交價" MarkerBorderColor="Red" MarkerBorderWidth="3" MarkerColor="Red" MarkerStyle="Circle" Name="Series1" Palette="Bright" XValueType="Double" YValueType="Int64" ChartType="Spline" Legend="Legend1" XValueMember="X軸" YValueMembers="成交價" MarkerStep="5" LabelForeColor="Red">
                            </asp:Series>
                              <asp:Series BackGradientStyle="Center" BackHatchStyle="Percent70" BackSecondaryColor="255, 255, 192" BorderColor="Blue" ChartArea="ChartArea1" Color="White" Font="Microsoft Sans Serif, 8pt, style=Italic" LabelBackColor="White" LabelToolTip="50日平均價" LegendText="50日平均價" LegendToolTip="50日平均價" MarkerBorderColor="Green" MarkerBorderWidth="3" MarkerColor="Green" MarkerStyle="Triangle" Name="Series2" Palette="Chocolate" XValueType="Double" YValueType="Int64" ChartType="Spline" Legend="Legend1" XValueMember="X軸" YValueMembers="均價" MarkerStep="5" LabelForeColor="Green">
                            </asp:Series>
                              <asp:Series BackGradientStyle="Center" BackHatchStyle="Percent70" BackSecondaryColor="255, 255, 192" BorderColor="Blue" ChartArea="ChartArea1" Color="White" Font="Microsoft Sans Serif, 8pt, style=Italic" LabelBackColor="White" LabelToolTip="上限" LegendText="上限" LegendToolTip="上限" MarkerBorderColor="SaddleBrown" MarkerBorderWidth="3" MarkerColor="SaddleBrown" MarkerStyle="Star5" Name="Series3" Palette="Berry" XValueType="Double" YValueType="Int64" ChartType="Spline" Legend="Legend1" XValueMember="X軸" YValueMembers="均價上限" MarkerStep="5" LabelForeColor="Blue">
                            </asp:Series>
                             <asp:Series BackGradientStyle="Center" BackHatchStyle="Percent70" BackSecondaryColor="255, 255, 192" BorderColor="Blue" ChartArea="ChartArea1" Color="White" Font="Microsoft Sans Serif, 8pt, style=Italic" LabelBackColor="White" LabelToolTip="下限" LegendText="下限" LegendToolTip="下限" MarkerBorderColor="SaddleBrown" MarkerBorderWidth="3" MarkerColor="DarkOrange" MarkerStyle="Star10" Name="Series4" Palette="Berry" XValueType="Double" YValueType="Int64" ChartType="Spline" Legend="Legend1" XValueMember="X軸" YValueMembers="均價下限" MarkerStep="5">
                            </asp:Series>
                        </series>
                        <chartareas>
                            <asp:ChartArea Name="ChartArea1" BackColor="White" ShadowColor="DimGray">
                        ...
                        <Titles>
                            <asp:Title BackColor="White" Font="標楷體, 20pt" ForeColor="Blue" Name="Title1" Text="預設成交價 (標準差1.5倍)">
                            </asp:Title>
            ...
            <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource2" ForeColor="Black" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellSpacing="2" PageSize="5">
                <Columns>
                    ...
                    <asp:BoundField DataField="macd紅綠棒值" HeaderText="macd紅綠棒值" SortExpression="macd紅綠棒值" />
                    <asp:BoundField DataField="今日J值" HeaderText="今日J值" SortExpression="今日J值" />
                    <asp:BoundField DataField="前一日J值" HeaderText="前一日J值" SortExpression="前一日J值" />
                    <asp:BoundField DataField="前二日J值" HeaderText="前二日J值" SortExpression="前二日J值" />
                    <asp:BoundField DataField="前三日J值" HeaderText="前三日J值" SortExpression="前三日J值" />
                    <asp:BoundField DataField="J值過三日高差值" HeaderText="J值過三日高差值" SortExpression="J值過三日高差值" />
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:stockchangedateConnectionString %>" SelectCommand="SELECT DISTINCT TOP (100) PERCENT View_basicinfo.名稱 AS 股票名稱, View_basicinfo.代號 AS 股票代號, View_basicinfo.成交價, View_basicinfo.漲跌, View_basicinfo.漲幅, View_basicinfo.總量, linedaysort.站均, avggold.均價黃金交叉次數, avggold.均量黃金交叉次數, avggold三大法人.三大法人黃金交叉次數, avggold三大法人.外資黃金交叉次數, avggold三大法人.投信黃金交叉次數, macdchartable.macd AS macd紅綠棒值, rsvjasc.當日J值一 AS 今日J值, rsvjasc.當日J值二 AS 前一日J值, rsvjasc.當日J值三 AS 前二日J值, rsvjasc.當日J值四 AS 前三日J值, rsvjasc.J值過高 AS J值過三日高差值, day1kd.k9, day1kd.d9, day1kd.週k9, day1kd.週d9, day1kd.月k9, day1kd.月d9, day1macd.macd, View_chips5table.集中度1日, View_chips5table.集中度5日, View_chips5table.集中度10日, View_chips5table.集中度20日, View_chips5table.集中度60日, View_value.本益比預估, View_value.本益比近四季, View_value.股價淨值比, View_value.現金殖利率, trend.一日漲幅, trend.三日漲幅, trend.五日漲幅, trend.十日漲幅, trend.二十日漲幅, trend.四十日漲幅, trend.六十日漲幅, todaydi.正DI, todaydi.負DI, todaydi.趨向ADX, todaydi.正趨百分比, todaydi.負趨百分比, todaydi.正負DI百分比, 主力加法人佔股本比彙總.[三大法人佔股本比%一天], 主力加法人佔股本比彙總.[主力佔股本比%一天], 主力加法人佔股本比彙總.合計一天, 主力加法人佔股本比彙總.法人三天, 主力加法人佔股本比彙總.主力三天, 主力加法人佔股本比彙總.合計三天, 主力加法人佔股本比彙總.法人五天, 主力加法人佔股本比彙總.主力五天, 主力加法人佔股本比彙總.合計五天, 主力加法人佔股本比彙總.法人十天, 主力加法人佔股本比彙總.主力十天, 主力加法人佔股本比彙總.合計十天, 主力加法人佔股本比彙總.法人二十天, 主力加法人佔股本比彙總.主力二十天, 主力加法人佔股本比彙總.合計二十天, 主力加法人佔股本比彙總.法人預設, 主力加法人佔股本比彙總.主力預設, 主力加法人佔股本比彙總.合計預設, View_weekequity.一週庫存比率, View_weekequity.二週庫存比率, View_weekequity.三週庫存比率, View_weekequity.四週庫存比率, View_weekequity.五週庫存比率, View_weekequity.六週庫存比率, View_weekequity.七週庫存比率, View_weekequity.近二期增幅, View_weekequity.近三期增幅, View_weekequity.近四期增幅, View_weekequity.近五期增幅, View_weekequity.近六期增幅, View_weekequity.近七期增幅, View_weekequity.最新週, avggold融資券.資使用率, avggold融資券.資使用率黃金交叉次數, avggold融資券.券使用率, avggold融資券.券使用率黃金交叉次數, avggold融資券.券資比, avggold融資券.券資比黃金交叉次數, avggold.產業分類, avggold.交易所分類, avggold.股本億, avggold.日期 FROM avggold INNER JOIN View_value ON avggold.股票代號 = View_value.代號 LEFT OUTER JOIN macdchartable ON avggold.日期 = macdchartable.日期 AND avggold.股票代號 = macdchartable.股票代號 LEFT OUTER JOIN rsvjasc ON avggold.股票代號 = rsvjasc.代號 LEFT OUTER JOIN View_chips5table ON avggold.股票代號 = View_chips5table.代號 RIGHT OUTER JOIN View_basicinfo ON avggold.股票代號 = View_basicinfo.代號 LEFT OUTER JOIN avggold融資券 ON avggold.股票代號 = avggold融資券.代號 LEFT OUTER JOIN View_weekequity ON avggold.股票代號 = View_weekequity.代號 LEFT OUTER JOIN linedaysort ON avggold.股票代號 = linedaysort.代號 LEFT OUTER JOIN day1macd ON avggold.股票代號 = day1macd.股票代號 LEFT OUTER JOIN day1kd ON avggold.股票代號 = day1kd.股票代號 LEFT OUTER JOIN avggold三大法人 ON avggold.股票代號 = avggold三大法人.股票代號 LEFT OUTER JOIN 主力加法人佔股本比彙總 ON avggold.股票代號 = 主力加法人佔股本比彙總.代號 LEFT OUTER JOIN todaydi ON avggold.股票代號 = todaydi.股票代號 LEFT OUTER JOIN trend ON avggold.股票代號 = trend.代號 WHERE (View_basicinfo.總量 &gt;= @總量) ORDER BY avggold.均價黃金交叉次數 DESC, avggold.均量黃金交叉次數 DESC, macd紅綠棒值 DESC">
             ...
             <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:stockchangedateConnectionString %>" SelectCommand="SELECT          標準差資訊2.自動編號, 標準差資訊2.名稱, 標準差資訊2.代號, basicinfo.成交價 as 成交價, basicinfo.總量 as 總量, 
...
WHERE          (標準差資訊2.日期 &gt;=  20220801) AND (標準差資訊2.名稱 = N'台積電')

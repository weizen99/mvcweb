<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="goldencross1.aspx.vb" Inherits="Web01.goldencross1" maintainscrollpositiononpostback="true" %>
    ...
    <form id="form1" runat="server">
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark ptest2">
        ...
        <span class="btn btn-default">
            ...
            )&nbsp;&nbsp;</span><asp:HyperLink ID="HyperLink46" runat="server" NavigateUrl="http://220.134.245.185:8888/Mvc%20web/goldencross1info.aspx">三大法人計算資訊</asp:HyperLink>
            ...
            </span></span>&nbsp;<asp:GridView ID="GridViewone" runat="server" AutoGenerateSelectButton="True" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" ForeColor="Black" CellSpacing="2">
            ...
            <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource2" ForeColor="Black" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellSpacing="2">
                <Columns>
                    ...
                    <asp:BoundField DataField="三大法人黃金交叉次數" HeaderText="三大法人黃金交叉次數" SortExpression="三大法人黃金交叉次數" ReadOnly="True" />
                    <asp:BoundField DataField="外資黃金交叉次數" HeaderText="外資黃金交叉次數" SortExpression="外資黃金交叉次數" ReadOnly="True" />
                    <asp:BoundField DataField="投信黃金交叉次數" HeaderText="投信黃金交叉次數" SortExpression="投信黃金交叉次數" ReadOnly="True" />
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:stockchangedateConnectionString %>" SelectCommand="SELECT DISTINCT 
                            TOP (100) PERCENT dbo.View_avglinethreecount1.股票名稱, dbo.View_avglinethreecount1.股票代號, 
                            dbo.View_avglinethreecount1.漲跌, dbo.View_avglinethreecount1.漲幅, dbo.View_avglinethreecount1.成交價, 
                            dbo.View_avglinethreecount1.總量, dbo.View_avglinethreecount1.三大法人黃金交叉次數, 
                            dbo.View_avglinethree外資count1.外資黃金交叉次數, dbo.View_avglinethree投信count1.投信黃金交叉次數, 
                            dbo.View_avglinethreecount1.產業分類, dbo.View_avglinethreecount1.交易所分類, 
                            dbo.View_avglinethreecount1.股本億
FROM              dbo.View_avglinethreecount1 INNER JOIN
                            dbo.View_avglinethree外資count1 ON 
                            dbo.View_avglinethreecount1.股票代號 = dbo.View_avglinethree外資count1.股票代號 INNER JOIN
                            dbo.View_avglinethree投信count1 ON 
                            dbo.View_avglinethree外資count1.股票代號 = dbo.View_avglinethree投信count1.股票代號
ORDER BY   dbo.View_avglinethreecount1.三大法人黃金交叉次數 DESC, 
                            dbo.View_avglinethree投信count1.投信黃金交叉次數 DESC, 
                            dbo.View_avglinethree外資count1.外資黃金交叉次數 DESC"></asp:SqlDataSource>

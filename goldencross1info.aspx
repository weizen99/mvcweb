<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="goldencross1info.aspx.vb" Inherits="Web01.goldencross1info" maintainscrollpositiononpostback="true" %>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark ptest2">
        ...
        <div>
            ...
            <asp:Button ID="Button3" runat="server" Text="設定查詢股票及區間" Width="167px" BackColor="Black" ForeColor="White" />
             ...
             (<asp:Button ID="計算56" runat="server" Height="31px" Text="顯示股權明細(含圖)" Width="164px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="輸入股票名稱" />
            ...
            <asp:Button ID="計算57" runat="server" Height="31px" Text="單查1000張以上" Width="130px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="輸入股票名稱" />
             ...
             <asp:Button ID="計算60" runat="server" Height="31px" Text="放大" Width="51px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" ToolTip="輸入股票名稱" />
     ...
     <asp:Label ID="Label28" runat="server" Font-Names="標楷體" ForeColor="#0000CC" Text="起日:"></asp:Label>
        ...
        <span class="btn btn-default">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="三大法人1日" HeaderText="三大法人1日" SortExpression="三大法人1日" />
                    <asp:BoundField DataField="三大法人5日均線" HeaderText="三大法人5日均線" SortExpression="三大法人5日均線" />
                    <asp:BoundField DataField="三大法人10日均線" HeaderText="三大法人10日均線" SortExpression="三大法人10日均線" />
                    <asp:BoundField DataField="三大法人20日均線" HeaderText="三大法人20日均線" SortExpression="三大法人20日均線" />
                    <asp:BoundField DataField="三大法人35日均線" HeaderText="三大法人35日均線" SortExpression="三大法人35日均線" />
                    <asp:BoundField DataField="三大法人60日均線" HeaderText="三大法人60日均線" SortExpression="三大法人60日均線" />
                    <asp:BoundField DataField="三大法人120日均線" HeaderText="三大法人120日均線" SortExpression="三大法人120日均線" />
                    <asp:BoundField DataField="三大法人200日均線" HeaderText="三大法人200日均線" SortExpression="三大法人200日均線" />
                    <asp:BoundField DataField="三大法人240日均線" HeaderText="三大法人240日均線" SortExpression="三大法人240日均線" />
                    <asp:BoundField DataField="一日交叉" HeaderText="一日交叉" SortExpression="一日交叉" ReadOnly="True" />
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:stockchangedateConnectionString %>" SelectCommand="SELECT DISTINCT 
                            TOP (100) PERCENT dbo.linethree1sum.stockname AS 股票名稱, dbo.linethree1sum.stockno AS 股票代號, 
                            dbo.linethree1sum.totolsum AS 三大法人1日, dbo.linethree5sum.totolsum AS 三大法人5日均線, 
                            dbo.linethree10sum.totolsum AS 三大法人10日均線, dbo.linethree20sum.totolsum AS 三大法人20日均線, 
                            dbo.linethree35sum.totolsum AS 三大法人35日均線, dbo.linethree60sum.totolsum AS 三大法人60日均線, 
                            dbo.linethree120sum.totolsum AS 三大法人120日均線, dbo.linethree200sum.totolsum AS 三大法人200日均線, 
                            dbo.linethree240sum.totolsum AS 三大法人240日均線, 
                            dbo.linethree1sum.totolsum - dbo.linethree5sum.totolsum AS 一日交叉, 
                            dbo.linethree5sum.totolsum - dbo.linethree10sum.totolsum AS 五日交叉, 
                            dbo.linethree10sum.totolsum - dbo.linethree20sum.totolsum AS 十日交叉, 
                            dbo.linethree20sum.totolsum - dbo.linethree35sum.totolsum AS 二十日交叉, 
                            dbo.linethree35sum.totolsum - dbo.linethree60sum.totolsum AS 三十五日交叉, 
                            dbo.linethree60sum.totolsum - dbo.linethree120sum.totolsum AS 六十日交叉, 
                            dbo.linethree120sum.totolsum - dbo.linethree200sum.totolsum AS 一百二十日交叉, 
                            dbo.linethree200sum.totolsum - dbo.linethree240sum.totolsum AS 二百日交叉
FROM              dbo.linethree1sum INNER JOIN
                            dbo.linethree5sum ON dbo.linethree1sum.stockno = dbo.linethree5sum.stockno INNER JOIN
                            dbo.linethree10sum ON dbo.linethree1sum.stockno = dbo.linethree10sum.stockno INNER JOIN
                            dbo.linethree20sum ON dbo.linethree1sum.stockno = dbo.linethree20sum.stockno INNER JOIN
                            dbo.linethree35sum ON dbo.linethree1sum.stockno = dbo.linethree35sum.stockno INNER JOIN
                            dbo.linethree60sum ON dbo.linethree1sum.stockno = dbo.linethree60sum.stockno INNER JOIN
                            dbo.linethree120sum ON dbo.linethree1sum.stockno = dbo.linethree120sum.stockno INNER JOIN
                            dbo.linethree200sum ON dbo.linethree1sum.stockno = dbo.linethree200sum.stockno INNER JOIN
                            dbo.linethree240sum ON dbo.linethree1sum.stockno = dbo.linethree240sum.stockno
ORDER BY   三大法人1日 DESC"></asp:SqlDataSource>

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="goldencross1picking.aspx.vb" Inherits="Web01.goldencross1picking" maintainscrollpositiononpostback="true"  %>
    ...
    <form id="form1" runat="server">
     ...
     <asp:Label ID="Label28" runat="server" Font-Names="標楷體" ForeColor="#0000CC" Text="起日:"></asp:Label>
        ...
        <span class="btn btn-default">
            ...
            )&nbsp; <asp:HyperLink ID="HyperLink46" runat="server" NavigateUrl="http://220.134.245.185:8888/Mvc%20web/goldencross1info.aspx">三大法人計算資訊</asp:HyperLink>
            <br />&nbsp;<asp:Label ID="Label29" runat="server" Text="選股:(Macd &gt;"></asp:Label>
                          <span class="style1"><span class="auto-style2 btn-default"><span class="auto-style4">
            ...
            </span></span></span>&nbsp;<asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource2" ForeColor="Black" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellSpacing="2" ToolTip="總量大於500張">
                <Columns>
                    ...
                    <asp:BoundField DataField="投信" HeaderText="投信" SortExpression="投信" />
                    <asp:BoundField DataField="外資" HeaderText="外資" SortExpression="外資" />
                    <asp:BoundField DataField="投信10日合計" HeaderText="投信10日合計" SortExpression="投信10日合計" />
                    <asp:BoundField DataField="外資10日合計" HeaderText="外資10日合計" SortExpression="外資10日合計" />
                    <asp:BoundField DataField="大戶持股週增減" HeaderText="大戶持股週增減" SortExpression="大戶持股週增減" />
                    <asp:BoundField DataField="券資比" HeaderText="券資比" SortExpression="券資比" />
                    <asp:BoundField DataField="年成長最新" HeaderText="年成長最新" SortExpression="年成長最新" />
                    <asp:BoundField DataField="累計營收年成長最新" HeaderText="累計營收年成長最新" SortExpression="累計營收年成長最新" />
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:stockchangedateConnectionString %>" SelectCommand="SELECT          TOP (100) PERCENT dbo.View_todaychips5.股票名稱, dbo.View_todaychips5.股票代號, dbo.View_todaychips5.漲幅, 
                            dbo.View_todaychips5.成交價, dbo.View_todaychips5.總量, dbo.avggold.均價黃金交叉次數, 
                            dbo.avggold.均量黃金交叉次數, dbo.avggold三大法人.三大法人黃金交叉次數, 
                            dbo.avggold三大法人.外資黃金交叉次數, dbo.avggold三大法人.投信黃金交叉次數, dbo.day1macd.macd, day1kd.日黃金交叉 as kd日黃金交叉, day1kd.週黃金交叉 as kd週黃金交叉, day1kd.月黃金交叉 as kd月黃金交叉, dbo.View_todaychips5.集中度1日, dbo.View_todaychips5.集中度5日, 
                            dbo.View_todaychips5.集中度10日, dbo.View_todaychips5.集中度20日, dbo.View_todaychips5.集中度60日, 
                            dbo.View_todaychips5.投信, dbo.View_todaychips5.外資, dbo.View_todaychips5.投信10日合計, 
                            dbo.View_todaychips5.外資10日合計, dbo.View_todaychips5.大戶持股週增減, dbo.View_todaychips5.券資比, 
                            dbo.View_todaychips5.年成長最新, dbo.View_todaychips5.累計營收年成長最新, dbo.View_todaychips5.本益比預估, 
                            dbo.avggold.產業分類, dbo.avggold.股本億, dbo.avggold.日期
FROM              dbo.avggold INNER JOIN
                            dbo.avggold三大法人 ON dbo.avggold.股票代號 = dbo.avggold三大法人.股票代號 INNER JOIN
                            dbo.day1kd ON dbo.avggold.股票代號 = dbo.day1kd.股票代號 INNER JOIN
                            dbo.day1macd ON dbo.avggold.股票代號 = dbo.day1macd.股票代號 INNER JOIN
                            dbo.View_todaychips5 ON dbo.avggold.股票代號 = dbo.View_todaychips5.股票代號
 where avggold三大法人.總量&gt;500 
ORDER BY   dbo.avggold.均價黃金交叉次數 DESC, dbo.avggold三大法人.三大法人黃金交叉次數 DESC, 
                            dbo.View_todaychips5.集中度1日 DESC"></asp:SqlDataSource>

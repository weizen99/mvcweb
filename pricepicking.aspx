<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pricepicking.aspx.vb" Inherits="Web01.pricepicking" maintainscrollpositiononpostback="true" %>
...
<body>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark ptest2">
                    ...
                    <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle" href="#" id="navbarDropdowntotol99" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                             ...
                             <a class="dropdown-item" href="http://220.134.245.185:8888/Mvc%20web/winnews/Index3">彙總查詢 自選股27</a>
                             <a class="dropdown-item" href="http://220.134.245.185:8888/Mvc%20web/winnews/Index4">彙總查詢 自選股28</a>
                             <a class="dropdown-item" href="http://220.134.245.185:8888/Mvc%20web/winnews/Index5">彙總查詢 自選股29</a>
                             <a class="dropdown-item" href="http://220.134.245.185:8888/Mvc%20web/winnewdates/Index">彙總查詢 單股多天</a>
                             <div class="dropdown-divider"></div>
        ...
        <asp:Label ID="Label26" runat="server" class="text-danger" Font-Bold="True" Font-Names="標楷體" Font-Size="Large" ForeColor="Blue" Text="名寫入到" ToolTip="當天也是可以查" CssClass="auto-style11"></asp:Label>
            ...
            <asp:ListItem Value="29">自選股29</asp:ListItem>
                          ...
                          <asp:Button ID="Button126" runat="server" BackColor="#003300" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" Height="34px" Text="加入自選股" Width="94px" ToolTip="原gridview整批加到下拉選單中的自選股中(針對下方的表格也可寫入自選股)" />

                          <asp:Button ID="Button144" runat="server" BackColor="#003300" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" Height="34px" Text="加入自選股win" Width="133px" ToolTip="單項查詢(輸入要取前?名)整批加到下拉選單中的自選股中(針對下方的表格也可寫入自選股)" />
            ) 
                          <span class="style1"><span class="auto-style2 btn-default"><span class="auto-style4">
                          <asp:CheckBox ID="不顯示" runat="server" ToolTip="gridview2及gridviewone互相切換分頁選擇(只能調整筆數不能支援分頁的顯示,不能選第二頁等單頁顯示全部才能使用選取功能)" />
 ...
 <br />
  ...
  </span></span></span>&nbsp;<span class="style1"><span class="auto-style2 btn-default"><span class="auto-style4">(<asp:Button ID="Button153" runat="server" Text="價增加4" Width="75px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量>=1000,近四期均價加總(近1天均價-近2年均價)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            <asp:Button ID="Button158" runat="server" Text="5" Width="32px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量>=1000,近5期均價加總(近1天均價-近2年均價)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            <asp:Button ID="Button159" runat="server" Text="6" Width="32px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量>=1000,近6期均價加總(近1天均價-近2年均價)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            <asp:Button ID="Button160" runat="server" Text="7" Width="32px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量>=1000,近7期均價加總(近1天均價-近2年均價)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            <asp:Button ID="Button161" runat="server" Text="8" Width="32px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量>=1000,近8期均價加總(近1天均價-近2年均價)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            )(<asp:Button ID="Button154" runat="server" Text="量增加4" Width="78px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量>=1000,近四期均量加總(近1天均量-近2年均量)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            <asp:Button ID="Button162" runat="server" Text="5" Width="32px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量>=1000,近5期均量"/>
          
            <asp:Button ID="Button163" runat="server" Text="6" Width="32px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量>=1000,近6期均量"/>
          
            <asp:Button ID="Button164" runat="server" Text="7" Width="32px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量>=1000,近7期均量"/>
          
            <asp:Button ID="Button165" runat="server" Text="8" Width="32px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量>=1000,近8期均量"/>
          
            )<asp:Button ID="Button155" runat="server" Text="三大法人增加" Width="122px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量>=1000,近四期均價加總(近1天均價-近2年均價)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            <asp:Button ID="Button156" runat="server" Text="外資增加" Width="98px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量>=1000,近四期均價加總(近1天均價-近2年均價)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
          
            <asp:Button ID="Button157" runat="server" Text="投信增加" Width="98px" BackColor="Black" ForeColor="White" Font-Names="標楷體" ToolTip="總量>=1000,近四期均價加總(近1天均價-近2年均價)+(近2天-近3天)+(近3天-近4天)+(近4天-近5天)"/>
                ...
                ) (<asp:Label ID="Label4" runat="server" Text="總量 &gt;"></asp:Label>
                          <asp:TextBox ID="總量" 

            runat="server" class="text-muted" Height="20px" Width="65px" Font-Size="Medium" ToolTip="輸入總量後,點選分頁或排序就會重新整理" CssClass="auto-style5 text-center" BackColor="#99FF66" ForeColor="Maroon">1000</asp:TextBox>
...
<asp:ListItem Value="dbo.主力加法人佔股本比彙總.合計預設">合計預設</asp:ListItem>
  ...
  </span></span></span><asp:GridView ID="GridViewone" runat="server" AutoGenerateSelectButton="True" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" ForeColor="Black" CellSpacing="2">
            ...
            <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource2" ForeColor="Black" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellSpacing="2">
                <Columns>
